...
@RestController
@RequestMapping("/api/video-streaming-agent-kafka")
public class VideoStreamingAgentKafkaResource {

    private final Logger log = LoggerFactory.getLogger(VideoStreamingAgentKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public VideoStreamingAgentKafkaResource(KafkaProperties kafkaProperties) {
